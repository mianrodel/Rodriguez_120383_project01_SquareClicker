...
class GAMECLASS:
    ...
    def start_or_null(self, x, y, win, t, t2, t3, start):
    ...
    def game_start(self, win):
        ...
        for i in range(1, 21):
            ...
            play_click_x, play_click_y = self.get_Click(win)
        ...
        square2.undraw()
        t1 = time.time()
        self.data_claculate_print(points, t0, t1, win)
    #END OF game_start()

    def data_claculate_print(self, points, t0, t1, win):
        accu = (points/20) * 100
        round(accu, 0)
        ...
        score = points + accu
        self.rankings(score, win)
    #END OF data_claculate_print()

    def rankings(self, score, win):
    ...
    #END OF rankings
    def run_game(self): 
        win, t, t2, t3, start = self.game_window_creation()
        x_click, y_click = self.get_Click(win)
        self.start_or_null(x_click, y_click, win, t, t2, t3, start)
        win.getMouse()
        win.close()